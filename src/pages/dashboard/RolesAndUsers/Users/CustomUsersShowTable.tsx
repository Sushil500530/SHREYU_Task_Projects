...
const CustomUsersShowTable = (props: TableProps) => {
                ...
                <table
                    ...
                    <thead className="bg-primary text-white table-hover">
                        <tr>
                            ...
                            <th className="border-1" style={{ width: "29%" }}>Name</th>
                            <th className="border-1" style={{ width: "29%" }}>Email</th>
                            <th className="border-1" style={{ width: "29%" }}>Role</th>
                                ...
                                <tr {...row.getRowProps()}>
                                    ...
                                    <td className="border-1">
                                        <div className="d-flex align-items-center justify-content-start gap-1">
                                            <span className="bg-primary text-white border-pill " style={{ padding: '0 6px', borderRadius: "6px" }}>{row.original.role[0]}</span>
                                            <span className="bg-primary text-white border-pill " style={{ padding: '0 6px', borderRadius: "6px" }}>{row.original.role[1]}</span>
                                        </div>
...
export default CustomUsersShowTable;